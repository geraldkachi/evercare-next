export const chronicConditionData = [
    ...
    { value: "Irritable bowel syndrome (IBS)", label: "Irritable bowel syndrome (IBS)" },
...
export const physicalActivityData = [
    ...
    { value: "Light exercise (e.g., walking, yoga)", label: "Light exercise (e.g., walking, yoga)" },
    { value: "Moderate exercise (e.g., jogging, swimming)", label: "Moderate exercise (e.g., jogging, swimming)" },
...
export const visitDoctorData = [
    { value: "Quarterly", label: "Quarterly" },
    { value: "Bi-annually", label: "Bi-annually" },
    { value: "Annually", label: "Annually" },
    { value: "As needed", label: "As needed" },
]
export const bloodSugarPressureData = [
    { value: "Approximately once a week", label: "Approximately once a week" },
    { value: "Approximately once a month", label: "Approximately once a month" },
    { value: "Approximately once a year", label: "Approximately once a year" },
]
export const recentLabTestsData = [
    { value: "Blood pressure", label: "Blood pressure" },
    { value: "Blood sugar", label: "Blood sugar" },
    { value: "Cholesterol", label: "Cholesterol" },
]
export const PreviousSurgeriesorHospitalizationsData = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
]
export const smokeTobaccoProductsData = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
]
...
// Do you have a family history of any chronic diseases (e.g., heart disease, diabetes, cancer)?
export const historyOfAnyChronicDiseasesData = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
]
//experienced any significant changes in your health or lifestyle recently
export const experiencedAnySignificantChangesInYourFealthoRLifestyleRecentlyData = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
]
// Do you feel pain when carrying out these activities?
export const doYouFeelPainWhenCarryingOutTheseActivitiesData = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
]

// What is the nature of the pain?
export const whatIsTheNatureOfThePainData = [
    { value: "Chronic pain (consistent pain that stays for long)", label: "Chronic pain (consistent pain that stays for long)" },
    { value: "Acute pain (short term pain that lasts for a short while)", label: "Acute pain (short term pain that lasts for a short while)" },
]
